...
![Health Check](https://github.com/f1stnpm2/doloribus-officia-repellat/workflows/Health%20Check/badge.svg)
...
```
$ npm install --save @f1stnpm2/doloribus-officia-repellat
```
...
import from `@f1stnpm2/doloribus-officia-repellat/immutable`.

```js
import vitruvius from '@f1stnpm2/doloribus-officia-repellat';
...
2.0](https://github.com/f1stnpm2/doloribus-officia-repellat/blob/master/LICENSE.txt).

## Code of Conduct
This project adheres to the [American Express Community Guidelines](https://github.com/f1stnpm2/doloribus-officia-repellat/wiki/Code-of-Conduct).
